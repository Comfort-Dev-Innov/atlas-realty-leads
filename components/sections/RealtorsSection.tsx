    ...
    const realtorContent = [
        {
            ...
            description: "Every lead is screened for intent, contactability, and timing."
        },
        {
            icon: PhoneIncoming,
            title: "Reachable Contacts",
            description: "You’re not chasing ghosts. We deliver sellers who pick up and talk."
        },
        {
            icon: Binary,
        ...
        },
        {
            ...
            description: "Pause, scale, or cancel anytime. You’re in the driver’s seat."
        },
        {
            icon: ReplaceAll,
        ...
        },
        {
            ...
            description: "$75 per lead. No setup fees. No contracts."
        }
    ]
            ...
            >
                ...
                {Array.from({ length: 150 }).map((_, index) => {
                    const particleTypes = [
                        ...
                        { size: "w-1.5 h-1.5", opacity: "bg-white/30", blur: "blur-[1px]" },
                ...
                <div className="relative z-10 px-8 sm:px-20 xl:px-40 py-50">
                    <div className='flex flex-col items-center justify-center space-y-16'>
                        ...
                        >
                            ...
                            >
                                We&apos;re more than just leads—we&apos;re consistent conversations with real sellers.
                            </motion.p>
                        </motion.div>
