    ...
    <MotionConfig reducedMotion={disableAnimations ? "always" : "never"}>
      <section className="p-8 sm:px-20 xl:px-40 sm:flex-1 w-full flex flex-col-reverse lg:flex-row gap-6 justify-between items-center">
        <div className="w-full lg:w-1/2">
            <h1 className="text-center lg:text-left text-[25px] min-[400px]:text-[35px] sm:text-[45px] xl:text-[65px] font-bold mb-6 leading-tight">
                <motion.div
            ...
            <motion.p 
                className="text-center lg:text-left text-md sm:text-xl xl:text-2xl mb-8 text-gray-900 leading-relaxed"
