  ...
  const testimonials: Testimonial[] = [
    {
      ...
      location: 'Dallas TX',
      content:
        'Within the first week, I had a solid seller conversation that turned into a signed listing. These leads are the real deal.',
    },
    {
      id: 2,
      name: 'Marcus V.',
      location: 'Phoenix AZ',
      content:
        "I've tried other services, but this is the first time I felt in control of the process. The flexibility and quality are unmatched.",
    },
    {
      id: 3,
      name: 'Angela R',
      location: 'Tampa FL',
      content:
        "The best part? These sellers actually answer the phone—and they're serious. I closed 2 deals in my first 30 days.",
    },
  ];
      ...
      >
        <div>
          ...
          <motion.p
            ...
            transition={{ duration: 0.6, delay: 0.4 }}
          >
            Hear from the real estate professionals who rely on Atlas Realty
            Leads.
          </motion.p>
        </div>
        <motion.div
        ...
        >
          ...
          >
            <span className="relative z-10">
              Join the Agents Getting Real Results
            </span>
          </Button>
        </motion.div>
      </section>
